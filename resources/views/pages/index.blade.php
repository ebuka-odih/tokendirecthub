                    ...
                    <div class="inner">
                        <div class="tableBox">
                            <div class="table_cellBox">
                                <div class="text_box">
                                    <h2>Access to an automated trading system, Commodities from {{ env('APP_NAME') }}</h2>
...
<div class="home_content">
        ...
        <div class="inner">
            <div class="home_row2_content">
                <div class="text_box">
                    ...
                    <p>{{ env('APP_NAME') }} is a <strong><a href="index.php/home/regulation.html">regulated</a></strong>  broker, providing traders with access to the global market through top tier FX liquidity providers.</p>
                    <p>With {{ env('APP_NAME') }}, you will experience super-fast trade execution, as well as interbank grade, RAW ECN spreads.  When combined, these elements offer clients a true institutional trading experience, across a wide range of trading instruments.</p>
                    <h3>Gain YOUR trading advantage with {{ env('APP_NAME') }}.</h3>
                </div>
    ...
    <div class="home_row3">
        <div class="inner">
            ...
            <div class="text_box">
                ...
                <p>Experience the difference with {{ env('APP_NAME') }} today.</p>
            ...
            <div class="home_row5_left">
                ...
                <!-- <div class="home_row5_video">
                    <div class="home_row5_video_box video_left">
                        ...
                        <p>
                          <img class="video_play" src="https://traderscorp.io/assets/home/wp-content/themes/vfx_new/images/home_row5_video_youtube.png" alt=""> LIVE ON {{ env('APP_NAME') }} TV
                        </p>
                        <h6>{{ env('APP_NAME') }} News</h6>
                    </div>
    ...
    <div class="home_row6">
        <div class="inner">
            <h2>trade your way <strong>with {{ env('APP_NAME') }}</strong></h2>
    ...
    <div class="home_row8">
        <div class="inner">
            <h2 class="page_title_center">Switch to {{ env('APP_NAME') }} Today and <strong>Experience the Difference</strong></h2>
            <ul class="home_three_rows">
                <li>
                    <div class="home_three_rows_box">
