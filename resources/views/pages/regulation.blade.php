        ...
        <div class="page_content">
            <div class="inner">
                <div class="page_top_text">
                    <h2><strong>THE {{ env('APP_NAME') }}</strong> DIFFERENCE</h2>
                ...
                <div class="corporate_box">
                    ...
                    <div class="corporate_list">
                        ...
                        <div class="text_box">
                            <p>{{ env('APP_NAME') }} fully complies with the strict financial regulations set out by the jurisdictions in which we are regulated. {{ env('APP_NAME') }} strives to provide transparent and fair access to global Forex markets.</p>
                        </div>
                    </div>
                    <div class="corporate_list">
                        <!--full 限制图片大小-->
                        ...
                        <div class="text_box">
                            <p>{{ env('APP_NAME') }} has Professional Indemnity Insurance in place which covers the work done by our representatives, employees and other authorised representatives.</p>
                        </div>
                    </div>
                </div>
                <div class="page_top_text">
                    <h2><strong>LICENSING</strong></h2>
                    <p>{{ env('APP_NAME') }} is a trademark of T-C Limited.</p>
