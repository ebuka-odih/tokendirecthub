            ...
            <div class="inner">
                <div class="page_top_text">
                    ...
                    <p>We continually strive to evolve our offering to ensure that we deliver a service that is far superior to anything else on the market.<br />
                        Smart traders make smart decisions, so become a {{ env('APP_NAME') }} client today and experience the difference.
                    </p>
                    <div class="clear"></div>
                </div>
                <div class="pages_text_and_image_row text_and_image_position_right">
                    <div class="text_and_image_inner">
                        <div class="text_box">
                            <h3>{{ env('APP_NAME') }} Values</h3>
                            <p>At {{ env('APP_NAME') }}, it is important for us to provide complete transparency in an often cloudy industry. That is why we go over and above to make ourselves available to fulfil the needs of our clients and continue to deliver an exceptionally reliable service.</p>
