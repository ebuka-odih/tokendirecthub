            ...
            <div class="inner">
                <div class="tableBox">
                    <div class="table_cellBox">
                        <div class="text_box">
                            <h2>Deposit Funds</h2>
                            <h3>Deposit Funds into Your {{ env('APP_NAME') }}<br>
                                Trading Account
                            </h3>
        ...
        <div class="page_content">
            <div class="inner">
                <div class="page_top_text">
                    ...
                    <p>{{ env('APP_NAME') }} enables clients to open accounts and deposit funds in the following base currencies:<br />
                ...
                <div class="deposit_content_list">
                    ...
                    <ul>
                        ...
                        <li>^ and ^^ {{ env('APP_NAME') }} may as a gesture of goodwill or as part of a promotion, cover fees charged by the merchant services provider by reimbursing them to your trading account. Contact your account manager for details.</li>
                ...
                <div class="page_top_text">
                    ...
                    <ul class="dotted_ul">
                        ...
                        <li>{{ env('APP_NAME') }} strictly does not accept third-party payments. All funds deposited into your trading account must be under the same name as your {{ env('APP_NAME') }} trading account. Payment from joint bank accounts or credit cards are accepted if the trading account holder is one of the beneficiaries.</li>
                        ...
                        <li>If your account was funded by credit card and a withdrawal is requested within 12 weeks, this withdrawal will be refunded back to the original credit card. The method by which we return client funds is at the sole discretion of {{ env('APP_NAME') }}.</li>
