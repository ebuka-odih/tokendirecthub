                    ...
                    <div class="uk-navbar-item" style="padding-top:20px;">
                        ...
                        <div>
                            <a class="" href="{{ route('index') }}">
                                <img class="uk-margin-small-right in-offset-top-10" style="margin-top: 3px" src="img/logo.png" data-src="img/logo.png" alt="{{ env('APP_NAME') }}" width="134" height="23" data-uk-img=""> </a>
