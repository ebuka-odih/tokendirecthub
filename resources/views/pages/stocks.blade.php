                    ...
                    <div class="uk-width-3-5@m">
                        <div class="uk-card uk-card-large uk-card-default in-card-paper">
                            <div class="uk-card-body">
                                <h2>Stocks</h2>
                                <p>A CFD, or Contract for Difference, is a type of financial instrument that allows you to trade on the price movements of stocks, regardless of whether prices are rising or falling. The key advantage of a CFD is the opportunity to speculate on the price movements of an asset (upwards or downwards) without actually owning the underlying asset.</p><p>
                                </p><p>
                                    Stock trading has been a popular financial pursuit since stocks were first introduced by the Dutch East India Company in the 17th century. This is both an efficient and effective type of investment for both families and individuals.</p>





                                <hr class="uk-margin-medium-top uk-margin-small-bottom uk-divider-icon">
                                <ul class="in-faq-5 uk-accordion" data-uk-accordion="collapsible: true">
                                    <li class="">
                                        <a class="uk-accordion-title" href="#">What Are Stocks</a>
                                ...
                                <ul class="in-faq-5 uk-accordion" data-uk-accordion="collapsible: true">
                                    <li class="uk-open">
                                        <a class="uk-accordion-title" href="#">How Do I Trade Stocks</a>
                                ...
                                <ul class="in-faq-5 uk-accordion" data-uk-accordion="collapsible: true">
                                    <li class="uk-open">
                                        <a class="uk-accordion-title" href="#">Stocks Trading Risk Assessment</a>
                                        <div class="uk-accordion-content">
                                ...
                                <div class="uk-card uk-card-default uk-card-small uk-card-body uk-border-rounded uk-margin-medium-top">
                                    <p class="uk-text-small text-capitalize">Lucrative Investment Opportunity At Your Fingertips.<a class="uk-link" href="register.html"> Start Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
