        ...
        <div class="inner">
            <div class="page_top_text">
                ...
                <p>Cash Indices and Commodities will settle at the end each business day (server time 00:00).<br />
                    {{ env('APP_NAME') }} is not involved in the physical delivery of trades, thus all positions left open at the end of the trading day will be rolled over to a new value date and will therefore have exposure to a swap charge or credit.
                </p>
